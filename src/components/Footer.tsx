            ...
            <div className="container mx-auto">
                <div className="grid  grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
                    <div className="item space-y-2 col-span-2 md:col-span-3 lg:col-span-1 mx-auto">
                        ...
                        />
                        <p>
                            At EY Solution, we understand the importance of
                            maintaining a clean and inviting environment that
                            resonates with the spirit of this remarkable city.
                            As your trusted cleaning partner,
                        </p>
                    ...
                    <div className="item space-y-2 col-span-2 md:col-span-1 lg:mx-auto">
                        <h4 className="heading-4 font-extrabold">
                            Contact Information
                        </h4>
                        <ul className="space-y-4">
